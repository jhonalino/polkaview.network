...
(async () => {
    ...
    for (let k = currentEraIndex; k <= currentEraIndex; k++) {
	    ...
	    if (lowestMinNominator) {
		    ...
		    client.set(`nominationLowest.totalStake.DOT`, lowestMinNominator.totalStake/ decimal_places, redis.print);
		    client.set(`nominationLowest.nominator.DOT`, lowestMinNominator.who, redis.print);
	    }
