...
export default function PrivacyPolicy(params) {
    return (
        <div className="text-white">
            ...
            <p>Your privacy is important to us. It is polkaview&#39;s policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <a href="https://polkaview.network">https://polkaview.network</a>, and other sites we own and operate. </p>
            ...
            <p>This policy is effective as of 26 May 2021. </p>
            <p>Last updated: 26 May 2021 </p>
            ...
            <p>polkaview team<br />hello@polkaview.network </p>
        </div>
    )
}