export default function FairUse(params) {
    return (
        <div>
            <h2>Acceptable Use Policy</h2>
            <p>This acceptable use policy covers the products, services, and technologies (collectively referred to as the &ldquo;Products&rdquo;) provided by polkaview under any ongoing agreement. It’s designed to protect us, our customers, and the general Internet community from unethical, irresponsible, and illegal activity. </p>
            <p>polkaview customers found engaging in activities prohibited by this acceptable use policy can be liable for service suspension and account termination. In extreme cases, we may be legally obliged to report such customers to the relevant authorities. </p>
            <p>This policy was last reviewed on 26 May 2021. </p>
            <h3>Fair use</h3>
            ...
            <h4>Unauthorized use of polkaview property</h4>
            <p>We prohibit the impersonation of polkaview, the representation of a significant business relationship with polkaview, or ownership of any polkaview property (including our Products and brand) for the purpose of fraudulently gaining service, custom, patronage, or user trust. </p>
